...
public class CookItemPane extends DevicePane {
    private static int cookItemCount = 0;
    ...
    public CookItemPane(Bezirk bezirk, Pane parent) {
        super(parent);
        cookItemCount ++;

        this.bezirk = bezirk;
        String lightId = String.valueOf(cookItemCount);
        this.light = new Light(lightId, "philiphs.hue.bulb.color");
        ...
        lightEvents.setEventReceiver((Event event, ZirkEndPoint sendor)-> {
